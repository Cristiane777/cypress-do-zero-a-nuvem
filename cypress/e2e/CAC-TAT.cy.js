describe('Central de Atendimento ao Cliente TAT', () => {
  ...
  it('preenche os campos obrigatórios e envia o formulário', ()=>{
    ...
    cy.get('#email').type('Cristiane@gmail.com')
  ...
  cy.get('#lastName')
    ...
    .should('have.value', '')
  cy.get('#email')
    .type('Cristiane@gmail.com')
    .should('have.value', 'Cristiane@gmail.com')
    .clear()
    .should('have.value', '')
  cy.get('#phone')
    .type('123456789')
...
it('acsessa a página da política de privacidade removendo o target e então clicando no link', () => {
  cy.contains('a','Política de Privacidade')
